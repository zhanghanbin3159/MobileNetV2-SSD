...
cp template/V1_with_new/MobileNetSSD_train_template.prototxt $trainfile
sed -i "s/cls6x/${cls_num6}/g" $trainfile
sed -i "s/cls3x/${cls_num3}/g" $trainfile
sed -i "s/cls1x/${cls_num}/g" $trainfile

cp template/V1_with_new/MobileNetSSD_test_template.prototxt $testfile
...
cp template/V1_with_new/MobileNetSSD_deploy_template.prototxt $deployfile
